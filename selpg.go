...
func Init(args *selpg_args) {
	...
	flag.IntVar(&args.page_len, "l", 5, "Lines per page.")
...
func Usage() {
  fmt.Fprintf(os.Stderr,
		`usage: [-s start page(>=1)] [-e end page(>=s)] [-l length of page(default 5)] [-f type of file(default 1)] [-d dest] [filename specify input file]
`)
}
